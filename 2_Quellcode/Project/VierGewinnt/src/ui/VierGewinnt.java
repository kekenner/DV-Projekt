...
public class VierGewinnt { // Hauptklasse
	...
	public static void main(String[] args) {
		...
		if (n == JOptionPane.NO_OPTION) {
			...
			String spieler2 = JOptionPane.showInputDialog(null, "Wie heißt der zweite Spieler?","Dein Name");
			...
			String spieler1 = JOptionPane.showInputDialog(null, "Wie heißt der erste Spieler?", "Dein Name");
		}
