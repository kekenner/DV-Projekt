 ...
 * Sie enth�lt die Methoden resetGameLogic, PaintComponent, checkField, resetandrepaintFields, checkWin und CheckDraw.
 * Diese Klasse ist mit der Spiellogik verkn�pft.
 * 
...
public class GamePanel extends JPanel implements MouseListener {
    ...
    /**
     * Methode checkField. Diese Methode �berpr�ft den Wert eines neu angeklickten Feldes.
    			...
    			if(field.getValue() == FieldValue.EMPTY) {
    				...
    				if(VierGewinnt.instance.getServerOderClient()== true ) {
    					...
    					//VierGewinnt.instance.getClient().empfange();   					
																...
																//				2. setzeZug(field.getCol) wird ausgef�hrt.
																//				3. Fenster wird f�r den Server Spieler gesperrt.
																//				4. Antwort des Client Spielers kommt.
																//				5. spieler.Wechseln wird ausgef�hrt.
																//    			6. Zug des Client Spielers setzen.
																//				7. spieler.Wechslen wird ausgef�hrt.
																//				8. Fenster wird f�r Server Spieler freigegeben.--> von vorne
    ...
    /**
     * Methode resetAndRepaintFields. Die Methode zeichnet nach jedem ausgef�hrten Zug das Spielfeld neu, somit wird der neu 
